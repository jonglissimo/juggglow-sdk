...
Service.prototype.scan = function(seconds) {
  return require('./service/scan')(seconds, this.foundProps, this._bluetooth, this);
};
...
Service.prototype.connect = function(peripheral) {
  return serviceFn.connect(peripheral, this.connectedProps, this._bluetooth, this);
};
...
Service.prototype.connectAll = function(count, race) {
  return serviceFn.connectAll(count, race, this.foundProps, this.connectedProps, this._bluetooth, this);
};
...
Service.prototype.standAloneModeAll = function(enable) {
  serviceFn.standAloneModeAll(enable, this.connectedProps);
};
...
Service.prototype.stopModeAll = function(duration) {
  serviceFn.stopModeAll(duration, this.connectedProps);
};
...
Service.prototype.standbyModeAll = function(duration) {
  serviceFn.standbyModeAll(duration, this.connectedProps);
};
...
Service.prototype.chargingIndicationAll = function(enable) {
  serviceFn.chargingIndicationAll(enable, this.connectedProps);
};
...
Service.prototype.txPowerAll = function(strength) {
  serviceFn.txPowerAll(strength, this.connectedProps);
};
...
Service.prototype.colorAll = function(color1, color2) {
  serviceFn.colorAll(color1, color2, this.connectedProps);
};
...
Service.prototype.fadeAll = function(colorStart, colorEnd, duration, mode) {
  serviceFn.fadeAll(colorStart, colorEnd, duration, mode, this.connectedProps);
};
...
Service.prototype.rainbowAll = function(duration, mode) {
  serviceFn.rainbowAll(duration, mode, this.connectedProps);
};
...
Service.prototype.strobeAll = function(duration, dutyCycle, color1, color2) {
  serviceFn.strobeAll(duration, dutyCycle, color1, color2, this.connectedProps);
};
...
Service.prototype.randomColorAll = function(interval, dutyCycle, mode) {
  serviceFn.randomColorAll(interval, dutyCycle, mode, this.connectedProps);
};
...
Service.prototype.runSequenceAll = function(sequenceNo, delay) {
  serviceFn.runSequenceAll(sequenceNo, delay, this.connectedProps);
};
...
Service.prototype.effectOnEvent = function(event, command, permanent) {
  serviceFn.effectOnEvent(event, command, permanent, this.connectedProps);
};
...
Service.prototype.removeEffectOnEventsAll = function() {
  serviceFn.removeEffectOnEventsAll(this.connectedProps);
};
...
Service.prototype.rawAll = function(command) {
  serviceFn.rawAll(command, this.connectedProps);
};
