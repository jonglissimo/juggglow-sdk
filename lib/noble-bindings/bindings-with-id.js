// Last update from noble master @ 4eb840c6f7634ca329654ec1b8b63c8d3f1f8c44
...
var AclStream = require('noble/lib/hci-socket/acl-stream');
var Gatt = require('noble/lib/hci-socket/gatt');
var Gap = require('noble/lib/hci-socket/gap');
var Hci = require('./hci-with-id');
var Signaling = require('noble/lib/hci-socket/signaling');


var NobleBindings = function(deviceId) {
  this._state = null;
