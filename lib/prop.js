...
Prop.prototype.color = function(options) {
  ...
  if (this._colorLastTime && now < this._colorLastTime + threshhold) {
      console.log('defer - last ' + this._colorLastTime + ' now ' + now);
      var deferTime = now;
      ...
      this._colorDeferTimer = setTimeout(function () {
        console.log('rund defered - last ' + that._colorLastTime + ' now ' + now);
      ...
      console.log('immediate prev last: ' + this._colorLastTime + ' now ' + now);
