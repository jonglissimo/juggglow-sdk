...
Prop.prototype.connect = function() {
  return propFn.connect(this, this._service._connectedProps, this._service, this._bluetooth);
};

Prop.prototype.shutdown = function() {
  return propFn.shutdown(this, this._service._connectedProps, this._characteristics.ballControl);
};
...
Prop.prototype.strobe = function(duration, dutyCycle, color1, color2) {
  propFn.strobe(duration, dutyCycle, color1, color2, this._characteristics.ballControl);
};

Prop.prototype.randomColor = function(duration, switchPercent, mode) {
  propFn.randomColor(duration, switchPercent, mode, this._characteristics.ballControl);
};
